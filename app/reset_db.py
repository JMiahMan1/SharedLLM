...
# Wipe HA Collection
try:
    ha_db = Chroma(collection_name="ha_sensors", embedding_function=emb, persist_directory=CHROMA_DIR)
...
try:
    nc_db = Chroma(collection_name="nextcloud_docs", embedding_function=emb, persist_directory=CHROMA_DIR)
