...
def test_identity_resolution_by_voice_id(client):
    ...
    print("[Test] Voice ID resolution successful.")
...
def test_api_key_generation_resolution_revocation(client):
    ...
    try:
        ...
        print("[Test] Resolving identity using the new custom API key...")
        ...
        print("[Test] Successfully revoked key.")
