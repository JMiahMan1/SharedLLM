...
async def test_get_dns_config_returns_mappings():
    ...
    mock_client.get.return_value = AsyncMock(
        json=lambda: [
            {"key": "dns_mappings", "value": '{"ollama-server": "192.168.2.114"}'},
    ...
    assert result["dns_mappings"] == {"ollama-server": "192.168.2.114"}
...
async def test_register_dns_entry_adds_mapping():
    ...
    body = json.dumps({"hostname": "new-host", "ip": "192.168.2.114"}).encode()
    ...
    assert patched_value["new-host"] == "192.168.2.114"
