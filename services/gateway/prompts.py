...
LIBRARIAN_SYSTEM_INSTRUCTION = (
    ...
    "5. **STRICT ACTION RULE**: Use `StorageListRequest` for NextCloud. Use `StorageIndexRequest` to scan files. Use `WebSearchRequest` for internet info. DO NOT provide a tutorial or guide when a tool call is appropriate.\n\n"
