...
AUTONOMOUS_EVOLUTION_AGENT_PROMPT = (
    ...
    "## TOOL CALL EXAMPLES (Ouroboros Protocol)\n"
    "**Git Pull:**\n"
    "```json\n"
    "{\n"
    "  \"action\": \"GitOperationRequest\",\n"
    "  \"payload\": { \"action\": \"pull\", \"branch\": \"microservices\" }\n"
    "}\n"
    "```\n"
    "**Read Code:**\n"
    "```json\n"
    ...
    "  \"payload\": { \"path\": \"services/gateway/main.py\", \"content\": \"...\", \"commit_after\": true, \"commit_message\": \"fix: ...\" }\n"
    "}\n"
    "```\n\n"
